...
object DbConstants {
    ...
    const val INVITES_TABLE = "invites"
    const val PRODUCTS_TABLE = "products"
    const val SUBSCRIPTIONS_TABLE = "subscriptions"
    const val BILLS_TABLE = "bills"
    const val BILL_PAYMENTS_TABLE = "billPayments"
    const val SENSITIVE_USER_DATA_TABLE = "sensitiveUserData"
