...
val MVPIcons.ProfileActionTeams: ImageVector
    get() {
        if (_ProfileActionTeams != null) {
            return _ProfileActionTeams!!
        }
        _ProfileActionTeams = ImageVector.Builder(
            name = "ProfileActionTeams",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _ProfileActionTeams: ImageVector? = null
