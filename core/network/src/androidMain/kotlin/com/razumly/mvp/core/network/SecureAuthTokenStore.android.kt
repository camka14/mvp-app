...
private var authTokenStoreContext: Context? = null

fun configureSecureAuthTokenStore(context: Context) {
    authTokenStoreContext = context.applicationContext
}
...
actual fun createSecureAuthTokenStore(): AuthTokenStore {
    val context = checkNotNull(authTokenStoreContext) {
        "configureSecureAuthTokenStore must be called before creating AuthTokenStore."
    }
