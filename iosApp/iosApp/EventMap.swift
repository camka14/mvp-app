...
class IOSNativeViewFactory: NativeViewFactory {
    ...
    func createNativeMapView(component: MapComponent, onEventSelected: @escaping (any EventAbs) -> Void, onPlaceSelected: @escaping (MVPPlace) -> Void, canClickPOI: Bool, focusedLocation: LatLng?, focusedEvent: (any EventAbs)?) -> UIViewController {
        let view = EventMap(
            component: component,
